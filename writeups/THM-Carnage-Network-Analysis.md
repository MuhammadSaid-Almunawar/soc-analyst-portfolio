...
![Conversations — IP Top Talkers](carnage_img04_conversations.png)
...
![Endpoints](carnage_img05_endpoints.png)
...
![Expert Information — Page 1](carnage_img06_expert_info1.png)
![Expert Information — Page 2](carnage_img07_expert_info2.png)
![Expert Information — Page 3](carnage_img08_expert_info3.png)
...
![HTTP Request Filter](carnage_img09_http_request_filter.png)
![Time Display Format Setting](carnage_img10_time_display.png)
...
![HTTP Stream — ZIP Download (Headers)](carnage_img11_http_stream_zip.png)
![HTTP Stream — ZIP Contents (XLS file inside)](carnage_img12_http_stream_xls.png)
...
![TLS Handshake — All Domains](carnage_img13_tls_handshake_domains.png)
...
![SNI — finejewels.com.au](carnage_img15_sni_finejewels.png)

**Domain 2 — thietbiagt.com**

![SNI — thietbiagt.com](carnage_img16_sni_thietbiagt.png)

**Domain 3 — new.americold.com**

![SNI — new.americold.com](carnage_img17_sni_americold.png)

To confirm the IP addresses of these domains, use `Statistics > Resolved Addresses`:

![Resolved Addresses](carnage_img18_resolved_addresses.png)
...
![TLS Certificate — GoDaddy Issuer (Detail)](carnage_img19_tls_cert_godaddy.png)
![TLS Certificate — GoDaddy Confirmation](carnage_img20_godaddy_issuer.png)
...
![Conversations — Cobalt Strike IPs](carnage_img21_conversations_cobalt.png)
...
![VirusTotal — 185.125.204.174](carnage_img22_vt_185125204174.png)
![VirusTotal — Community Comments (Cobalt Strike confirmed)](carnage_img24_vt_community_cobalt2.png)

Community member `drb_ra` confirmed: *"Cobalt Strike Server Found — C2: HTTPS @ 185.125.204.174:4444"*

**185.106.96.158** — VirusTotal:

![VirusTotal — 185.106.96.158 (6/91 malicious)](carnage_img23_vt_18510696158.png)
...
![HTTP Traffic to 185.106.96.158](carnage_img25_cobalt1_http_filter.png)
![TCP Stream — Host Header revealed](carnage_img26_cobalt1_host_header.png)
...
![VirusTotal Relations — survmeter.live](carnage_img27_vt_relations_survmeter.png)

**185.125.204.174 → securitybusinpuff.com**

![VirusTotal Relations — securitybusinpuff.com](carnage_img28_vt_relations_securitybusinpuff.png)
...
![POST Requests to Malicious Domain](carnage_img30_post_filter.png)
![HTTP Stream — POST to maldivehost.net](carnage_img29_post_maldivehost.png)
...
![Server Header Confirmation](carnage_img31_post_server_header.png)
...
![DNS Query for api.ipify.org](carnage_img32_dns_ipify.png)
![UDP Stream — ipify.org DNS resolution](carnage_img33_dns_ipify_stream.png)
![HTTPS Traffic to api.ipify.org](carnage_img34_ipify_traffic.png)
...
![SMTP — MAIL FROM Filter](carnage_img35_smtp_mailfrom.png)
![SMTP — Full Traffic View](carnage_img36_smtp_full.png)
